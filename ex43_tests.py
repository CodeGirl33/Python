...
class CentralCorridor(Scene):
    def enter(self):
        print(dedent("""The Gothons of planet Percal No25 have invaded your ship
        and destroyed your crew. You are the sole survivor, and your last mission is to get the neutron destruct bomb
...
class EscapePod(Scene):
    def enter(self):
        ...
        if int(guess) != good_pod:
            print(dedent("""You jump into pod{guess} and hit the eject
...
class Map(object):
    ...
    'the_bridge': TheBridge(), 'escape_pod': EscapePod(),
    'death': Death(), 'finished': Finished(),}
